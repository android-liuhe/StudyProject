package demo.study.com.studyproject.design.singletion;
/**
 * Created by liuhe on 19-2-28.
 * 单例模式的六种写法
 */
...
//    }
    ...
    public static Singleton getInstance() {
        return SingletionHolder.sInsance;
    }
    private static class SingletionHolder {
        private static final Singleton sInsance = new Singleton();
    }
}
